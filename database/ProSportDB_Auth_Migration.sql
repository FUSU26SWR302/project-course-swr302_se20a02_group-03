...
-- Date: 2026-05-26
-- ============================================================================
-- H??NG D?N: Ch?y script này trên SSMS ?? c?p nh?t schema cho h? th?ng Auth.
-- ============================================================================
...
-- Cho phép PasswordHash ???c NULL (?? dùng Google Login)
ALTER TABLE [dbo].[Users] ALTER COLUMN [PasswordHash] VARCHAR(500) NULL;
GO

-- Thêm c?t GoogleId và IsPhoneVerified
...
-- Thêm Unique Index cho GoogleId (n?u khác NULL)
